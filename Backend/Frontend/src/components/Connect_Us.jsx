...
//     const response = await fetch("http://127.0.0.1:8000/contact/connect/", {
//       method: "POST",
//       headers: {
...
//           <div className="w-16 h-1 bg-cyan-400 mt-4 rounded-full"></div>
...
//             <button
//               type="submit"
//               className="w-full bg-cyan-500 hover:bg-cyan-600 text-white py-4 rounded-xl font-semibold transition duration-300 hover:scale-[1.02] shadow-lg shadow-cyan-500/40"
//             >
//               Send Message
//             </button>
